                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <div class="d-flex flex-column mb-4">
                                    <span class="h3 mb-0 mb-1 pb-3" style="color: #1C78D3">₦ {{ i.original_price.toLocaleString() }}</span>
                                </div>
                            ...
                            <div class="d-flex flex-row">
                                <button type="button" class="btn btn-primary flex-fill me-1" style="color: white;">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
