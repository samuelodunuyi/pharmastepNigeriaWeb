...
<template>
    ...
    <div>
        ...
        <section>
            ...
            <div class="row sety">
                <div class="col-6 col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0 fullCate" v-for="i in categories">
                    <div class="card text-black" @click="$router.push(`/category/${i.id}`)">
                        <div class="pickgradient" style="cursor: pointer;">
                            <img :src="i.img" class="card-img-top d-none d-sm-block" alt="category" height="300" />
                            <img :src="i.img" class="card-img-top d-block d-sm-none" alt="category" height="100" />
                        </div>
                        <div class="card-body">
                            <div class="text-center mt-1" style="cursor: pointer;">
                                <h4 class="card-title d-none d-sm-block" >{{ i.name }}</h4>
                                <h6 class="card-title d-block d-sm-none" style="font-size: 4vw;">{{ i.name }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0 fullCate" v-for="i in products">
