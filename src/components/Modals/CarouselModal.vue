<template>
  <div class="modals-container">
    <article class="carousel-modal product-carousel">
      <!-- Close button -->
      <button class="button-icon product-carousel__button--close" @click="$emit('closeProductCarouselModal')">
        <img src="../../assets/icon-close.svg" alt="Next" />
      </button>
      <div class="product-carousel__container">
        <CarouselSlide v-for="(slide, index) in slides" :key="index" :image="slide.main" :index="index"
